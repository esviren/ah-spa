<template>
    <div class="max-w-6xl mx-auto px-4 py-6">
      ...
      <div class="flex justify-between items-center mb-6">
        <p class="text-gray-600">
          Encontramos {{ listings.length }} in {{ location }}, 1 to {{ listings.length }} ads
        </p>
      ...
      <div class="space-y-4">
        ...
        >
          ...
          <div class="relative md:w-1/3 h-64 md:h-auto">
            ...
            >
              <svg
                ...
                class="h-5 w-5"
                :class="listing.isFavorite ? 'text-orange-500 fill-orange-500' : 'text-gray-400'"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
          ...
          <div class="p-6 flex-1 flex flex-col">
            ...
            <div class="text-3xl font-bold mb-1">{{ formatPrice(listing.price, listing.currency) }}</div>
            ...
            <div class="flex items-center mb-6">
              <span
                ...
                :class="listing.condition === 'New' ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'"
              >
                <svg
  ...
  const listings = ref(props.initialListings.length ? props.initialListings : [
    {
      seller: 'Javier López',
      price: 9000000,
      currency: 'USD',
      ...
      condition: 'Used',
      image: 'https://upload.wikimedia.org/wikipedia/commons/f/fa/Apple_MacBookPros_13-15-17_stacked_08-2009.jpg',
      isFavorite: false
    },
    {
      seller: 'Contactar',
      ...
      condition: 'New',
      image: 'https://upload.wikimedia.org/wikipedia/commons/0/08/JuniorSuite.JPG',
      isFavorite: false
    },
    {
      seller: 'Alexandra',
      ...
      description: 'El Xiaomi Redmi Note 13 con 8GB de RAM y 256GB de almacenamiento interno es un smartphone que destaca por su rendimiento y capacidad de almacenamiento.',
      condition: 'Used',
      image: 'https://upload.wikimedia.org/wikipedia/commons/a/a2/IPhone_13_Pro_camera_lens_group.jpg',
      isFavorite: false
    }
  ]);
